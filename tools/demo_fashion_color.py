...
def demo(net, image_name):
    ...
    # Load the demo image
    im_file = os.path.join(cfg.DATA_DIR, 'fashion', image_name)
    ...
    bboxes=[]
    for cls_ind, cls in enumerate(CLASSES): #CLASSES[1:]):
...
if __name__ == '__main__':
    ...
    caffemodel = os.path.join('/data/Ivan/Projects/py-faster-rcnn/saved_caffe_weights_fashion',
    ...
    im_names = ['00041.jpg', '00042.jpg', '00043.jpg',
                '00044.jpg', '00045.jpg']
